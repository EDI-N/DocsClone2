...
def setup(app):
    ...
    app.add_javascript('OneSignalSDKWorker.js')
...
htmlhelp_basename = 'DocsdocClone'
...
latex_documents = [
    ('index', 'Clone.tex', 'Clone Documentation',
     'Clone', 'manual'),
]
...
man_pages = [
    ('index', 'docs', 'Clone Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Docs', 'Clone Documentation',
